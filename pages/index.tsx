...
export default function HomePage() {
  ...
  const codeLines = [
    ...
    { code: "    name: 'Patrick Raul Lang',", type: 'array-item' },
    { code: "    role: 'Master Student, Sofware Developer, UI/UX Desinger',", type: 'array-item' },
    { code: "    bio: 'Building things and hope they dont break'", type: 'array-item' },
    { code: '  };', type: 'array-end' },
    { code: '', type: 'blank' },
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <h1 className={styles.developerName}>
            Patrick Raul <span className={styles.accentText}>Lang</span>
          </h1>

          <div className={styles.developerRole}>Master Student, Sofware Developer, UI/UX Desinger</div>
